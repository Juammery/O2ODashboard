...
class BsActiveForm extends CActiveForm
{
     ...
     * @see BSHtml::activeUneditableFieldControlGroup
     */
    public function customStaticTextControlGroup($input, $labelname, $htmlOptions = array())
    {
        $htmlOptions = $this->processRowOptions(NULL, $labelname, $htmlOptions);
        $htmlOptions['label'] = $labelname;
        $input = BSHtml::tag('p',array('class'=>'form-control-static'),$input,true);
       // $htmlOptions['controlOptions'] = array('class'=>'form-control-static');
        return BSHtml::customControlGroup($input,$labelname, $htmlOptions);
    }
     ...
     * @see BSHtml::activeUneditableFieldControlGroup
     */
    public function custominputControlGroup($input, $labelname="", $htmlOptions = array())
    {
        $htmlOptions = $this->processRowOptions(NULL, $labelname, $htmlOptions);
         $htmlOptions['label'] = $labelname;
        return BSHtml::customControlGroup($input,$labelname, $htmlOptions);
    ...
    protected function processRowOptions($model, $attribute, $options)
    {
        ...
        $error = $model ? $this->error($model, $attribute, $errorOptions):array();
