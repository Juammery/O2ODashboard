<div style="width:50%;display:inline-block;" class="col-md-6 bs">
    <div class="bl">
    ...
    <div  class="center-block">
        <ng-echarts class="echarts" ec-config="pieConfig" ec-option="<?= $kpiname ?>" style="width: 150px;height: 150px;margin: auto;"></ng-echarts>
