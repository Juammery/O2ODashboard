...
<div class="col-md-6 qwe bs">
    <div class="bl">
        <div class="bl1"  ng-bind="((kocount*1.0/nartdcount*100) |number:1)+'%'" ng-cloak></div>
        <span class="vs" ng-cloak>vs 上月</span>
        <div class="bl2">
            <span ng-if="kocount/nartdcount-lastkocount/lastnartdcount>0" ng-cloak>
                <span class="green" ng-bind="((kocount/nartdcount-lastkocount/lastnartdcount)*100).toFixed(1) + '%'"></span>
                <img src="<?php echo Yii::app()->baseUrl ?>/images/small_up.png">
            </span>
            <span ng-if="kocount/nartdcount-lastkocount/lastnartdcount<0" ng-cloak>
                <span class="change" ng-bind="((kocount/nartdcount-lastkocount/lastnartdcount)*100).toFixed(1) + '%'"></span>
                <img src="<?php echo Yii::app()->baseUrl ?>/images/small_down.png">
            </span>
            <span ng-if="kocount==null" ng-cloak>
                <?= Yii::t('cvs', 'N/A'); ?>
            </span>
        </div>
    </div>
