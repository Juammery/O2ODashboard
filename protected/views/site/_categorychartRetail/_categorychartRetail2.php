<div class="chart-box" style="height: 523px;" ng-if="visitab=='average_selling_price' && history.average_selling_price==0" ng-init="setstackbaroption('average_selling_price')">
