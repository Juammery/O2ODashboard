<div class="chart-box up-down" style="height: 523px; text-align: center" ng-if="visitab=='average_number_per_unit'&&history.average_number_per_unit==1" when-scrolled="myFunction1()">
