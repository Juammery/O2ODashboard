<div class="chart-box up-down" style="height: 523px; text-align: center" ng-if="visitab=='average_purchase_price' && history.average_purchase_price==1" when-scrolled="myFunction1()">
