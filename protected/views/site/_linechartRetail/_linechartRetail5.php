<div class="chart-box up-down" style="height: 523px; text-align: center" ng-if="history.average_discount_factor==1 && visitab=='average_discount_factor'" when-scrolled="myFunction1()">
