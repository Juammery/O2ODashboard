<div class="chart-box up-down" style="height: 523px; text-align: center" ng-if="history.price_promotion_ratio==1 && visitab=='price_promotion_ratio'" when-scrolled="myFunction1()">
