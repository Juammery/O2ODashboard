<div class="chart-box up-down" style="height: 523px; text-align: center" ng-if="visitab=='distribution_store' && history.distribution_store==1" when-scrolled="myFunction1()">
